...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    // Load a google map into our maps fragment
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Center location on OC4008
        map = googleMap;
        LatLng oc4008 = new LatLng(33.190802, -117.301805);
        ...
        // 2) Center our marker there
        CameraPosition position = new CameraPosition.Builder().target(oc4008).zoom(15f).build();
        CameraUpdate update = CameraUpdateFactory.newCameraPosition(position);
        map.moveCamera(update);

        // 3) Add normal markers for each of the caffiene locations
